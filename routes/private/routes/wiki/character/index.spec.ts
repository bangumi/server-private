  ...
  test('should get current wiki info', async () => {
    ...
    expect(res.json()).toMatchInlineSnapshot(`
      ...
      |引用来源= Wikipedia
        ...
        "name": "ルルーシュ・ランペルージ",
        "summary": "鲁路修·兰佩洛基是日本动画《Code Geass 反叛的鲁路修》中的主角。
    ...
    expect(res.json()).toMatchInlineSnapshot(`
      Object {
        "data": Array [
          ...
          Object {
            "commitMessage": "手贱弄错了条目，已报错，等管理员恢复版本",
            "createdAt": 1603386845,
            "creator": Object {
              "username": "261227",
            },
            "id": 1198707,
          ...
          Object {
            "commitMessage": "bgm_wikihelper脚本替换条目",
            "createdAt": 1603385600,
            "creator": Object {
              "username": "261227",
            },
            "id": 1198703,
          ...
          Object {
            "commitMessage": "引用来源不能引用自身啊=_,=",
            "createdAt": 1389727628,
            "creator": Object {
              "username": "14382",
            },
            "id": 190704,
