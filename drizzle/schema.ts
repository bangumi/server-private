...
export const chiiSubjectFields = mysqlTable('chii_subject_fields', {
  ...
  rate1: mediumint('field_rate_1').default(0).notNull(),
  rate2: mediumint('field_rate_2').default(0).notNull(),
  rate3: mediumint('field_rate_3').default(0).notNull(),
  rate4: mediumint('field_rate_4').default(0).notNull(),
  rate5: mediumint('field_rate_5').default(0).notNull(),
  rate6: mediumint('field_rate_6').default(0).notNull(),
  rate7: mediumint('field_rate_7').default(0).notNull(),
  rate8: mediumint('field_rate_8').default(0).notNull(),
  rate9: mediumint('field_rate_9').default(0).notNull(),
  rate10: mediumint('field_rate_10').default(0).notNull(),
