...
export const CommentState = Object.freeze({
  Normal: 0, // 正常
  AdminCloseTopic: 1, // CommentStateAdminCloseTopic 管理员关闭主题 https://bgm.tv/subject/topic/12629#post_108127
  AdminReopen: 2, // 重开
  AdminPin: 3, // 置顶
  AdminMerge: 4, // 合并
  AdminSilentTopic: 5, // CommentStateAdminSilentTopic 管理员下沉 https://bgm.tv/subject/topic/18784#post_160402
  UserDelete: 6, // 自行删除
  AdminDelete: 7, // 管理员删除
  AdminOffTopic: 8, // 折叠
});
