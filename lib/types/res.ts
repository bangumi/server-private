...
export const User = t.Object(
  {
    ...
    homepage: common.Ref(UserHomepage),
  },
  { $id: 'User', title: 'User' },
);
...
export const Subject = t.Object(
  {
    airtime: common.Ref(SubjectAirtime),
    collection: common.Ref(SubjectCollection),
    eps: t.Integer(),
    id: t.Integer(),
    images: t.Optional(common.Ref(SubjectImages)),
    infobox: common.Ref(Infobox),
    info: t.String(),
    ...
    nameCN: t.String(),
    nsfw: t.Boolean(),
    platform: common.Ref(SubjectPlatform),
    rating: common.Ref(SubjectRating),
    redirect: t.Integer(),
    series: t.Boolean(),
    ...
    volumes: t.Integer(),
    tags: t.Array(common.Ref(SubjectTag)),
  },
  {
    $id: 'Subject',
    title: 'Subject',
...
export const SubjectStaffPosition = t.Object(
  {
    type: common.Ref(SubjectStaffPositionType),
    summary: t.String(),
  },
...
export const Episode = t.Object(
  {
    ...
    subjectID: t.Integer(),
    sort: t.Number(),
    type: common.Ref(common.EpisodeType),
    disc: t.Integer(),
    name: t.String(),
    nameCN: t.String(),
    duration: t.String(),
...
export const Character = t.Object(
  {
    ...
    infobox: common.Ref(Infobox),
    summary: t.String(),
    images: t.Optional(common.Ref(PersonImages)),
    comment: t.Integer(),
    collects: t.Integer(),
    lock: t.Boolean(),
    redirect: t.Integer(),
...
export const SubjectComment = t.Object(
  {
    user: common.Ref(SlimUser),
    type: common.Ref(common.CollectionType),
    rate: t.Integer(),
    comment: t.String(),
    updatedAt: t.Integer(),
  },
...
export const SubjectReview = t.Object(
  {
    id: t.Integer(),
    user: common.Ref(SlimUser),
    entry: common.Ref(SlimBlogEntry),
  },
...
export const SubjectRelation = t.Object(
  {
    subject: common.Ref(SlimSubject),
    relation: common.Ref(SubjectRelationType),
    order: t.Integer(),
  },
  { $id: 'SubjectRelation' },
);
...
export const SubjectCharacter = t.Object(
  {
    character: common.Ref(SlimCharacter),
    actors: t.Array(common.Ref(SlimPerson)),
    type: t.Integer(),
    order: t.Integer(),
  },
  { $id: 'SubjectCharacter' },
...
export const SubjectStaff = t.Object(
  {
    person: common.Ref(SlimPerson),
    positions: t.Array(common.Ref(SubjectStaffPosition)),
  },
  { $id: 'SubjectStaff' },
);
...
export const PersonCharacter = t.Object(
  {
    character: common.Ref(SlimCharacter),
    relations: t.Array(common.Ref(CharacterSubjectRelation)),
  },
  { $id: 'PersonCharacter' },
);
...
export const Index = t.Object(
  {
    ...
    total: t.Integer(),
    collects: t.Integer(),
    stats: common.Ref(IndexStats),
    createdAt: t.Integer(),
    updatedAt: t.Integer(),
    creator: common.Ref(SlimUser),
  },
...
export const SubReply = t.Object(
  {
    ...
    text: t.String(),
    state: t.Integer(),
    reactions: t.Array(common.Ref(Reaction)),
  },
...
export const Reply = t.Object(
  {
    id: t.Integer(),
    isFriend: t.Boolean(),
    replies: t.Array(common.Ref(SubReply)),
    creator: common.Ref(SlimUser),
    createdAt: t.Integer(),
    text: t.String(),
    state: t.Integer(),
...
export const TopicDetail = t.Object(
  {
    id: t.Integer(),
    parent: t.Union([common.Ref(Group), common.Ref(SlimSubject)]),
    creator: common.Ref(SlimUser),
    title: t.String(),
    text: t.String(),
    state: t.Integer(),
    createdAt: t.Integer(),
    replies: t.Array(common.Ref(Reply)),
    reactions: t.Array(common.Ref(Reaction)),
  },
...
export const TimelineMemo = t.Object(
  {
    daily: t.Optional(
      t.Object({
        users: t.Optional(t.Array(common.Ref(SlimUser))),
        groups: t.Optional(t.Array(common.Ref(SlimGroup))),
      }),
    ),
    wiki: t.Optional(
      t.Object({
        subject: t.Optional(common.Ref(SlimSubject)),
      }),
    ),
    subject: t.Optional(
      t.Array(
    ...
    blog: t.Optional(common.Ref(SlimBlogEntry)),
    index: t.Optional(common.Ref(SlimIndex)),
    mono: t.Optional(
      t.Object({
        characters: t.Array(common.Ref(SlimCharacter)),
        persons: t.Array(common.Ref(SlimPerson)),
      }),
    ),
  },
...
export const Timeline = t.Object(
  {
    id: t.Integer(),
    uid: t.Integer(),
    user: t.Optional(common.Ref(SlimUser)),
    cat: common.Ref(TimelineCat),
    type: t.Integer(),
    memo: common.Ref(TimelineMemo),
    batch: t.Boolean(),
    source: common.Ref(TimelineSource),
    replies: t.Integer(),
    createdAt: t.Integer(),
  },
