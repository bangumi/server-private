...
export interface SubjectRelationRevSelf {
  subject_id: string;
...
export interface SubjectRelationRevRemote {
  subject_id: string;
  subject_type_id: string;
  relation_type: string;
  related_subject_id: string;
...
export interface SubjectRelationRev {
  self: Record<string, SubjectRelationRevSelf>;
  remote: Record<string, SubjectRelationRevRemote>;
}
